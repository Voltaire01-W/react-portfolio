...
import FIREBIRD from "../../assets/img/projects/phoenix.png";
...
const TimeLine = () => {
  return (
    <div id="projects">
      ...
      <Timeline>
        <Events>
          {/* Project: Firebird Mobile */}
        <ImageEvent
            date="6/14/2021"
            className="text-center"
            text="Firebird Mobile"
            src={FIREBIRD}
            alt="firebird.social"
          >
            <div className="d-flex justify-content-between flex-column mt-1">
                ...
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong> What's on your mind? Go ahead and share it in a post, or customize your profile with a Bio and Picture! Join the Mobile App today!
                        <hr />
                        <strong>Features:</strong>
                        <ul className="list-styles pt-1">
                          <li>Create an account with email authentication</li>
                          <li>Create Posts or Comments</li>
                          <li>Like your friends posts!</li>
                          <li>Notifications, Messaging, Search Users</li>
                        </ul>
                        <hr />
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton
                  href="https://expo.io/@voltaire/firebird_social/"
                  target="_blank"
                >
                  SEE LIVE
                </UrlButton>
                <UrlButton
                  href="https://github.com/Voltaire01-W/Social_Media_App_Native"
                  target="_blank"
                >
                  SOURCE CODE
                </UrlButton>
      ...
      {/* Project: Firebird Web App */}
        <ImageEvent
            date="5/19/2021"
            className="text-center"
            text="Firebird Social"
            src={FIREBIRD}
            alt="firebird.social"
          >
            <div className="d-flex justify-content-between flex-column mt-1">
              <div>
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong> What's on your mind? Go ahead and share it in a post, or customize your profile with a Bio and Picture! We look forward to seeing you on there!
                        <hr />
                        <strong>Features:</strong>
                        <ul className="list-styles pt-1">
                          <li>Create an account with email authentication</li>
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton
                  href="https://firebird.social/"
                  target="_blank"
                >
                  SEE LIVE
                </UrlButton>
                <UrlButton
                  href="https://github.com/Voltaire01-W/Social_Media_App_Frontend"
                  target="_blank"
                >
                  SOURCE CODE
                </UrlButton>
